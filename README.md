...
[1.Hive简单介绍](Hive/1.Hive简单介绍.md)

[2.Hive的运行和配置](Hive/2.Hive的运行和配置.md)

[1.Hive常见的练习题](Hive/1.Hive常见的练习题.md)

[2.Hive元数据信息对应的MySQL数据表](Hive/2.Hive元数据信息对应的MySQL数据表.md)

[3.Hive和HBase整合之后数据的存储位置](Hive/3.Hive和HBase整合之后数据的存储位置.md)
